...
/**
 * Executes a query on a SQLite database and calls the provided callback for each row returned
...
/**
 * Compares two objects based on a specified key from the keymap.
