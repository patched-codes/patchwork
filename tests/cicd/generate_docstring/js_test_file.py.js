...
/**
 * Executes the provided query on the SQLite database and invokes the callback for each result row.
 * @param {Object} db - The SQLite database connection instance
