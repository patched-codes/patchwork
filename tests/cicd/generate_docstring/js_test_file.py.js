...
/**
 * Executes a given SQL query on a SQLite database and applies a callback function to each result row.
 ...
 * @returns {number} Returns -1 if the value of the key in the first object is less than the second object,
