...
/**
 * Executes a SQLite query on the given database and calls a callback function for each row of the result.
...
const sqlite = (db, query, callback) => {
    /**
     * Executes a query on the database serially and applies a callback for each row
     * @param {string} query - The SQL query to execute
