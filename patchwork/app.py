...
def find_patchflow(possible_module_paths: Iterable[str], patchflow: str) -> Any | None:
    allowed_modules = {"safe_module1", "safe_module2", "safe_module3"}  # Define allowed modules here
    for module_path in possible_module_paths:
        ...
        if module_path in allowed_modules:
            ...
            logger.warning(f"Module {module_path} is not in the allowed list of modules.")
