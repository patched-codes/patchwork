...
def find_patchflow(possible_module_paths: Iterable[str], patchflow: str) -> Any | None:
    allowed_modules = {'allowed_module_1', 'allowed_module_2'}  # Example whitelist of allowed modules
    for module_path in possible_module_paths:
        ...
        if module_path in allowed_modules:
            ...
            logger.warning(f"Module {module_path} is not in the whitelist and will not be imported.")
