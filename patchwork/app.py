...
def find_patchflow(possible_module_paths: Iterable[str], patchflow: str) -> Any | None:
    allowed_modules = {'allowed.module.path1', 'allowed.module.path2'}  # Define allowed modules
    for module_path in possible_module_paths:
        ...
        if module_path in allowed_modules:  # Check if module path is in the whitelist
            try:
