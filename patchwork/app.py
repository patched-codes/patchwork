...
def find_patchflow(possible_module_paths: Iterable[str], patchflow: str) -> Any | None:
    whitelisted_modules = {"trusted_module1", "trusted_module2", "trusted_module3"}  # Define trusted modules
    ...
    for module_path in possible_module_paths:
        ...
        try:
            if module_path in whitelisted_modules:
                ...
                logger.warning(f"Module {module_path} is not in the whitelist and will not be loaded.")
