...
def find_patchflow(possible_module_paths: Iterable[str], patchflow: str) -> Any | None:
    allowed_modules = {"module1", "module2", "module3"}  # whitelist of allowed modules
    for module_path in possible_module_paths:
        ...
        if module_path in allowed_modules:
            ...
            logger.debug(f"Module {module_path} is not in the allowed list and will not be imported.")
