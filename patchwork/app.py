...
def find_patchflow(possible_module_paths: Iterable[str], patchflow: str) -> Any | None:
    safe_modules = ["module1", "module2"]  # Define a list of safe module names
    ...
    for module_path in possible_module_paths:
        ...
        if module_path in safe_modules:  # Check if the module is in the safe_modules list
            try:
            ...
            logger.error("Unsafe module path detected: {}".format(module_path))
