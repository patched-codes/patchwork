...
def find_patchflow(possible_module_paths: Iterable[str], patchflow: str) -> Any | None:
    trusted_modules = {'trusted_module_a', 'trusted_module_b'}  # define your allowed module names here
    for module_path in possible_module_paths:
        ...
        if module_path in trusted_modules:
            ...
            logger.warning(f"Attempt to import untrusted module {module_path} was blocked.")
