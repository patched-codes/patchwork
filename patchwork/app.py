...
def find_patchflow(possible_module_paths: Iterable[str], patchflow: str) -> Any | None:
    trusted_modules = {"trusted.module1", "trusted.module2"}  # Example whitelist
    ...
    for module_path in possible_module_paths:
        ...
        if module_path in trusted_modules:
            ...
            logger.warning(f"Module {module_path} is not in the list of trusted modules and won't be imported.")
