...
def find_patchflow(possible_module_paths: Iterable[str], patchflow: str) -> Any | None:
    ...
    allowed_modules = {"allowed.module1", "allowed.module2", "allowed.module3"}
    ...
    for module_path in possible_module_paths:
        ...
        # Check if the module_path is in the allowed_modules whitelist
        if module_path in allowed_modules:
            ...
            logger.warning(f"Attempted import of untrusted module: {module_path}")
