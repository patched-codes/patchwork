...
def find_patchflow(possible_module_paths: Iterable[str], patchflow: str, allowed_modules: Iterable[str]) -> Any | None:
    for module_path in possible_module_paths:
        ...
        if module_path in allowed_modules:
            ...
            logger.debug(f"Module {module_path} is not in the allowed module list")
