...
def find_module(possible_module_paths: Iterable[str], patchflow: str) -> ModuleType | None:
    for module_path in possible_module_paths:
        ...
        if module_path not in ['trusted_module_1', 'trusted_module_2']:  # Add trusted module check here
            logger.warning(f"Attempted to import untrusted module: {module_path}")
            continue
