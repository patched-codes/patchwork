...
def find_module(possible_module_paths: Iterable[str], patchflow: str) -> ModuleType | None:
    for module_path in possible_module_paths:
        ...
        try:
            if module_path not in ['whitelisted_module_1', 'whitelisted_module_2']:  # Add whitelisted modules
                raise ModuleNotFoundError(f"Module {module_path} is not whitelisted")
