...
def find_patchflow(possible_module_paths: Iterable[str], patchflow: str) -> Any | None:
    validated_modules = {'allowed_module1', 'allowed_module2'}
    ...
    for module_path in possible_module_paths:
        ...
        if module_path in validated_modules:
            try:
            ...
            logger.debug(f"Module {module_path} is not in the validated module list.")
