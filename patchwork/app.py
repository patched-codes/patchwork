...
def find_patchflow(possible_module_paths: Iterable[str], patchflow: str) -> Any | None:
    allowed_modules = {"trusted_module1", "trusted_module2"}  # Add specific trusted module names
    for module_path in possible_module_paths:
        ...
        if module_path in allowed_modules:
            ...
            logger.debug(f"Module {module_path} is not in the allowed modules whitelist")
